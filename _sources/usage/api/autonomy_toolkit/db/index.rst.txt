:mod:`autonomy_toolkit.db`
==========================

.. py:module:: autonomy_toolkit.db
...
.. autoapisummary::
   ...
   autonomy_toolkit.db.ATKDatabase
   autonomy_toolkit.db.ATKDataFile
   autonomy_toolkit.db.ATKDataFileWriter
   autonomy_toolkit.db.ATKDataFileReader
...
.. autoapisummary::
   ...
   autonomy_toolkit.db.register_type
...
.. py:class:: ATKDatabase(local_path: Union['Path', str])
   ...
   .. method:: push(self, bag: Union['ATKDataFile', str], keep: bool = True)
      ...
      :Parameters: * **bag** (*Union[ATKDataFile, str]*) -- The bag file to push.
                   * **keep** (*bool, optional*) -- If False, will delete the file after pushing it.


   .. method:: pull(self, name: str, dest: str = None, as_rosbag: bool = False) -> 'ATKDataFile'
...
.. py:class:: ATKDataFile(path: str)
   ...
   .. method:: reader(self)
      ...
      :returns: *ATKDataFileReader* -- The file reader
...
.. py:class:: ATKDataFileWriter(path: Union[Path, str], type: int = 0)
   ...
   .. method:: open(self) -> 'Union[_ATKROS1DataFileWriter, _ATKROS2DataFileWriter]'

      Method which will return either a :class:`~_ATKROS1DataFileWriter` or a
      :class:`~_ATKROS2DataFileWriter`.

      :returns: *Union[_ATKROS1DataFileWriter, _ATKROS2DataFileWriter]* -- The correct writer for the bag type.
...
.. py:class:: ATKDataFileReader(path: Union[Path, str])
   ...
   .. method:: open(self) -> 'Union[_ATKROS1DataFileReader, _ATKROS2DataFileReader]'

      Method which will return either a :class:`~_ATKROS1DataFileReader` or a
      :class:`~_ATKROS2DataFileReader`.

      :returns: *Union[_ATKROS1DataFileReader, _ATKROS2DataFileReader]* -- The correct reader for the bag type.
