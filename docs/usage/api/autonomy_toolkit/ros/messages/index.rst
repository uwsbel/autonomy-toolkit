:mod:`autonomy_toolkit.ros.messages`
====================================

.. py:module:: autonomy_toolkit.ros.messages
...
.. autoapisummary::
   ...
   autonomy_toolkit.ros.messages.MessageType
...
.. py:class:: MessageType
   ...
   :ivar file: the path to the .msg file that defines the data types
   :vartype file: str
   :ivar name: the nameof the message type (i.e. std_msgs/msg/Header)
